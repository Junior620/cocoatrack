-- ============================================================================
-- CocoaTrack V2 - Fix list_parcelles for NULL cooperative_id
-- Updates RPC functions to handle parcelles/planteurs without cooperative
-- ============================================================================
...
-- ============================================================================
-- Function: list_parcelles (updated for NULL cooperative_id)
-- Now handles parcelles where planteur.cooperative_id is NULL
-- Access via cooperative_id OR created_by
-- ============================================================================
...
BEGIN
  ...
  -- Get user's cooperative_id (can be NULL)
  ...
  -- Access condition: cooperative matches OR (cooperative is NULL AND created_by matches)
  SELECT COUNT(*) INTO v_total
  FROM public.parcelles par
  LEFT JOIN public.planteurs pl ON pl.id = par.planteur_id
  WHERE (
      -- Case 1: Planteur has cooperative that matches user's cooperative
      (pl.cooperative_id IS NOT NULL AND pl.cooperative_id = v_user_cooperative_id)
      OR
      -- Case 2: Planteur has no cooperative but was created by user
      (pl.cooperative_id IS NULL AND pl.created_by = v_user_id)
      OR
      -- Case 3: Parcelle was created by user (direct ownership)
...
-- ============================================================================
-- Function: get_parcelle (updated for NULL cooperative_id)
-- ============================================================================
