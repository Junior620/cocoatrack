-- ============================================================================
-- Migration: Security Fixes - Warnings
-- Description: Corrections des warnings de sécurité (WARN)
--              - Function search_path mutable (18 fonctions)
--              - RLS policies always true (9 policies)
-- Date: 2026-03-28
-- Author: Security Audit
-- Related: SECURITY_WARNINGS_FIXES.sql
-- ============================================================================

-- ============================================================================
-- SECTION 1: Fix Function Search Path (18 fonctions)
-- ============================================================================
-- Problème: Fonctions sans search_path fixe, vulnérables aux attaques par injection
-- Solution: Ajouter SET search_path = public, pg_temp à toutes les fonctions
...
-- ============================================================================
-- Problème: Policies avec USING (true) ou WITH CHECK (true) trop permissives
-- Solution: Restreindre l'accès aux managers et admins pour clients/contracts/shipments
...
-- 1. audit_logs et sync_processed:
--    Les policies permissives (true) sont intentionnelles pour ces tables.
--    Elles ne sont PAS modifiées dans cette migration.
--
...
--    Doit être activé manuellement dans Supabase Dashboard:
