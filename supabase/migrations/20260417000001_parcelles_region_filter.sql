-- ============================================================================
-- Migration: Parcelles Region Filter
-- Description: Ajoute la colonne region sur la table parcelles
--              et met à jour list_parcelles pour supporter le filtre p_region
-- Date: 2026-04-17
-- ============================================================================

-- ============================================================================
-- SECTION 1: Ajouter la colonne region sur parcelles
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_parcelles_region
  ON public.parcelles (region)
  WHERE region IS NOT NULL;

-- ============================================================================
-- SECTION 2: Mettre à jour list_parcelles avec p_region
-- ============================================================================

-- Drop toutes les versions existantes de list_parcelles
-- (plusieurs signatures coexistent en base suite aux migrations précédentes)
DROP FUNCTION IF EXISTS public.list_parcelles(UUID, TEXT, TEXT, TEXT, TEXT, UUID, TEXT, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, BOOLEAN, INTEGER, INTEGER);
...
-- NOTES
-- ============================================================================
-- 1. La colonne region est nullable (les parcelles existantes auront NULL)
-- 2. Le filtre p_region est optionnel : NULL = toutes les régions
-- 3. Valeurs attendues : les 10 régions du Cameroun
--    Adamaoua, Centre, Est, Extrême-Nord, Littoral,
--    Nord, Nord-Ouest, Ouest, Sud, Sud-Ouest
-- 4. p_simplify est ajouté pour la simplification géométrique (zoom faible)
-- ============================================================================
