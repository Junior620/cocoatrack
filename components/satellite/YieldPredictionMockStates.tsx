/**
 * YieldPredictionMockStates - États Mockés pour Screenshots
 * 
 ...
 * 
 * NOUVEAU FICHIER pour contourner cache Turbopack
 */

'use client';

interface YieldPredictionMockStatesProps {
...
export function YieldPredictionMockStates({ state }: YieldPredictionMockStatesProps) {
  ...
  const mockData = {
    ...
    'medium': {
      ...
      cooperativeAvg: 500,
      harvestSeason: 'Q4-2026',
      predictionDate: '15 juin 2026',
      meanNDVI: 0.62,
      ndviTrend: 0.008,
      historicalYield: [],
      surfaceHa: 3.2,
